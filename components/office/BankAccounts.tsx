...
// // Transaction interface for statement data
...
// // Extended BankAccount interface for UI (maps from BankAccountDto)
...
// // Stats interface matching backend BankAccountStatsDto
// interface BankStats {
...
//   const mapDtoToAccount = (dto: BankAccountDto): BankAccount => {
//     const currency = dto.currency === 0 ? "KES" : "USD";
//     return {
//       id: dto.id,
//       code: dto.code,
...
//       // These will be populated from stats or statement
//       kesDebit: currency === "KES" ? Math.max(0, dto.balance) : 0,
//       kesCredit: currency === "KES" ? Math.max(0, -dto.balance) : 0,
//       usdDebit: currency === "USD" ? Math.max(0, dto.balance) : 0,
//       usdCredit: currency === "USD" ? Math.max(0, -dto.balance) : 0,
//       status: dto.isActive ? "active" : "inactive",
//       opened: new Date(dto.createdAt).toLocaleDateString(),
...
//       if (response.success && response.data) {
//         // Map statement data to transactions
...
//             accountName: txn.relatedAccountName || "Unknown",
//             accountId: txn.relatedAccountId || "",
//             effect: txn.type === 0 || txn.type === "debit" ? "credit" : "debit",
//             balanceAfter: txn.relatedAccountBalanceAfter || 0,
//           },
//         }));
...
//   const totalKesDebit = stats.totalDebitKES;
//   const totalKesCredit = stats.totalCreditKES;
//   const totalUsdDebit = stats.totalDebitUSD;
//   const totalUsdCredit = stats.totalCreditUSD;
...
//                         {selectedAccount.currency === "KES" ? "KES " : "$"}
...
//                     </div>
//                     <div className="bg-white/10 backdrop-blur-sm p-4 border border-white/20">
//                       <p className="text-xs text-blue-200 mb-1">Net Change</p>
//                       <p
...
//                       {accountToDelete.currency === "KES" ? "KES " : "$"}
