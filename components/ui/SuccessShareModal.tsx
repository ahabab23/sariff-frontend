        ...
        <div className="bg-gradient-to-r from-green-500 to-emerald-600 px-6 py-5 text-white">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-green-100">Completed successfully</p>
            </div>
          </div>
        </div>
        ...
        <div className="px-6 pb-5 pt-2 space-y-3">
          {whatsappPhone && whatsappMessage && (
            <div className="flex gap-2">
              <button
                onClick={() => shareViaWhatsApp(whatsappPhone, whatsappMessage)}
                className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-semibold rounded-lg bg-green-600 text-white hover:bg-green-700 shadow-sm transition-colors"
              >
