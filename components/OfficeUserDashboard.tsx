...
const ClientManagement = dynamic(
  () =>
    import("./office/ClientManagement").then((m) => ({
...
const Reconciliation = dynamic(
  () =>
    import("./office/Reconciliation").then((m) => ({
...
const MPesaAccounts = dynamic(
  () =>
    import("./office/MPesaAccounts").then((m) => ({
      default: m.MPesaAccounts,
    })),
  {
    ssr: false,
    loading: TabLoadingSpinner,
...
const ExchangeSection = dynamic(
  () =>
    import("./office/ExchangeSection").then((m) => ({
      default: m.ExchangeSection,
    })),
  {
    ssr: false,
    loading: TabLoadingSpinner,
...
const OfficeSettings = dynamic(
  () =>
    import("./office/OfficeSettings").then((m) => ({
      default: m.OfficeSettings,
    })),
  {
    ssr: false,
    loading: TabLoadingSpinner,
...
const ExpensesAccount = dynamic(
  () =>
    import("./office/ExpensesAccount").then((m) => ({
      default: m.ExpensesAccount,
    })),
  {
    ssr: false,
    loading: TabLoadingSpinner,
